...
export default function Layout() {
  ...
  return (
    ...
    <div className="h-screen overflow-hidden flex flex-col text-slate-100 bg-slate-950">
      ...
      ════════════════════════════════════════════════════════════ */}
      <footer className="flex-shrink-0 z-50 bg-slate-950 border-t border-white/5 shadow-[0_-4px_20px_rgba(0,0,0,0.6)]"
        style={{ height: 64 }}>
        <div className="h-full mx-auto max-w-[1400px] flex items-center justify-between px-6 gap-6">

          {/* LHS: copyright */}
          <span className="text-[9px] font-black tracking-[0.5em] uppercase text-white/15 shrink-0">
            © {new Date().getFullYear()} VABK
          </span>

          {/* CENTER: University badges */}
          <div className="flex items-center gap-6 justify-center flex-1">
            <div className="flex items-center gap-2 opacity-35 hover:opacity-80 transition-opacity cursor-default">
              <svg width="26" height="26" viewBox="0 0 26 26">
                <rect width="26" height="26" rx="3" fill="#CC0000" />
                <text x="13" y="18" textAnchor="middle" fontSize="9" fontWeight="900" fontFamily="Georgia,serif" fill="white">SDSU</text>
              </svg>
              <span className="text-[9px] font-black tracking-widest uppercase text-white/40 leading-tight hidden lg:block">San Diego State Univ.</span>
            </div>
            <div className="w-px h-5 bg-white/10" />
            <div className="flex items-center gap-2 opacity-35 hover:opacity-80 transition-opacity cursor-default">
              <svg width="26" height="26" viewBox="0 0 26 26">
                <rect width="26" height="26" rx="3" fill="#003087" />
                <text x="13" y="11" textAnchor="middle" fontSize="5.5" fontWeight="900" fontFamily="Georgia,serif" fill="#FFD700">UNIV OF</text>
                <text x="13" y="20" textAnchor="middle" fontSize="5" fontWeight="900" fontFamily="Georgia,serif" fill="white">CUMBERLANDS</text>
              </svg>
              <span className="text-[9px] font-black tracking-widest uppercase text-white/40 leading-tight hidden lg:block">Univ. of Cumberlands</span>
            </div>
          </div>

          {/* RHS: Social icon links */}
          <div className="flex items-center gap-7 shrink-0">
            <a title="GitHub" href={profile.links.github} target="_blank" rel="noreferrer" className="text-white/20 hover:text-amber-400 transition-all hover:scale-125 duration-200">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" />
                <path d="M9 18c-4.51 2-5-2-7-2" />
              </svg>
            </a>
            <a title="LinkedIn" href={profile.links.linkedin} target="_blank" rel="noreferrer" className="text-white/20 hover:text-amber-400 transition-all hover:scale-125 duration-200">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />
                <rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" />
              </svg>
            </a>
            <a title="Medium" href={profile.links.medium} target="_blank" rel="noreferrer" className="text-white/20 hover:text-amber-400 transition-all hover:scale-125 duration-200">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M13.54 12a6.8 6.8 0 0 1-6.77 6.82A6.8 6.8 0 0 1 0 12a6.8 6.8 0 0 1 6.77-6.82A6.8 6.8 0 0 1 13.54 12zm7.42 0c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z" />
              </svg>
            </a>
            <a title="Google Scholar" href={profile.links.scholar} target="_blank" rel="noreferrer" className="text-white/20 hover:text-amber-400 transition-all hover:scale-125 duration-200">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
