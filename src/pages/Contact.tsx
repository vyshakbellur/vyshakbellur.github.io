      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="section-enter space-y-4">
          <div className="rounded-xl border border-white/14 bg-white/[0.06] p-6">
            <div className="text-[10px] font-medium tracking-widest uppercase text-white/45 mb-3">Available For</div>
          ...
          <div className="rounded-xl border border-white/14 bg-white/[0.06] p-6">
            <div className="text-[10px] font-medium tracking-widest uppercase text-white/45 mb-3">Links</div>
