  ...
  return (
    <div ref={sectionRef} className="mx-auto max-w-6xl px-5 py-14">
      ...
      <div className="mb-14 space-y-4">
        <h2 className="section-enter text-xl font-semibold tracking-tight text-white/95 mb-6">Education</h2>
        
        <div className="section-enter rounded-2xl border border-white/10 bg-white/5 p-6 flex flex-col justify-between">
          <div className="mb-2 font-semibold text-white/90">University of Cumberlands</div>
          <div className="text-sm font-medium text-gold mb-2">Ph.D. Candidate</div>
          <p className="text-sm leading-relaxed text-white/60">Advancing computational methods and structural analysis.</p>
        </div>

        <div className="section-enter rounded-2xl border border-white/10 bg-white/5 p-6 flex flex-col justify-between">
          <div className="mb-2 font-semibold text-white/90">San Diego State University</div>
          <div className="text-sm font-medium text-gold mb-2">Master of Science (M.S.)</div>
          <p className="text-sm leading-relaxed text-white/60">Collaborative research in microbiome network architectures and bioinformatics.</p>
        </div>
      </div>

      <div className="space-y-4">
        <h2 className="section-enter text-xl font-semibold tracking-tight text-white/95 mb-6">Certifications</h2>
