...
export default function Experience() {
  ...
  return (
    <>
      ...
      {/* ── DESKTOP MODE: Strict 45-Degree Angular SVG Graph & Holographic HUD ── */}
      <div className="hidden lg:flex min-h-screen lg:h-screen lg:max-h-screen bg-[#050505] text-[#c9d1d9] font-mono lg:overflow-hidden items-center justify-center px-4 lg:px-12 py-8 lg:py-0 gap-8 lg:gap-12">
        ...
        <div className="w-1/2 flex flex-col items-center justify-center h-full">
          <div 
            ...
            style={{ boxShadow: `0 25px 50px -12px rgba(0,0,0,0.8), inset 0 0 20px ${color}15` }}
          >
            ...
            <div className="flex flex-col p-10 z-10 relative h-[450px]">
              ...
              {selected && (
                <div className="flex flex-col z-20 h-full">
                  <h3 
                    className="text-2xl font-black tracking-widest uppercase mb-2 transition-colors duration-500 shrink-0"
                  ...
                  <ul className="space-y-4 overflow-y-auto holo-scrollbar pr-2 pb-2 flex-grow auto-rows-max">
      ...
      {/* ── MOBILE MODE: Continuous Chronological Feed ── */}
      <div className="lg:hidden flex flex-col min-h-screen bg-[#050505] text-[#c9d1d9] font-mono px-6 py-12">
        <h1 className="text-2xl font-black mb-10 tracking-[0.2em] uppercase text-white/90">Experience</h1>
        <div className="flex flex-col gap-10 border-l border-white/10 ml-2 pb-16">
          {SVG_NODES.map(node => {
            const dt = NODE_DATA[node.id];
            return (
              <div key={node.id} className="relative pl-8">
                ...
                />
                <h3 className="text-lg font-black tracking-widest uppercase mb-1" style={{ color: node.color }}>
                  {dt.company}
                </h3>
